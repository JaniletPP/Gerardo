...
<head>
    ...
    <title>Búsqueda Asíncrona</title>
    ...
    <script>
        function handleSearch(event) {
            ...
            document.getElementById('results').innerHTML = '<p class="text-center">Cargando...</p>';

            // Realizar la petición Fetch
            fetch(buscar.php?search=${encodeURIComponent(search)}&categoria=${encodeURIComponent(categoria)})
            ...
            .then(data => {
                ...
                if (data.length > 0) {
                    ...
                    resultsDiv.innerHTML = '<p class="text-danger text-center">No se encontraron resultados.</p>';
                }
            })
            .catch(error => {
                document.getElementById('results').innerHTML = '<p class="text-danger">Error en la búsqueda.</p>';
...
<div class="container mt-4">
    <h2 class="text-center">Búsqueda Asíncrona</h2>
